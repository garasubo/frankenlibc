...
EXTRAFLAGS="-F CPPFLAGS=${EXTRA_CPPFLAGS} -F ACFLAGS=${EXTRA_AFLAGS} -F CWARNFLAGS=${EXTRA_CWARNFLAGS} -F CFLAGS=${EXTRA_CFLAGS} -F CPPFLAGS=-mfpu=neon -F ACLFLAGS=-mfpu=neon ${EXTRAFLAGS}"
